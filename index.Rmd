...
# Dados já agregados pelo notebook Gera-dados-infografico-cotas
  ...
  tagList(
    div(class = "twitter-followers",
        div(class = "followers-header",
            ...
            "Percentual de Ingresso de Servidores Públicos Federais por Meio de Cotas Raciais a partir de novembro de 2023 a junho de 2026"
        )
    ),
    tbl,
    tags$button(
